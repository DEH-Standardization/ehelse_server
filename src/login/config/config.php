...
define("DB_NAME", "andrkje_login");
define("DB_USER", "andrkje_ehelse");
define("DB_PASS", "ehelse12");
...
define("COOKIE_DOMAIN", ".http://localhost/login/");
define("COOKIE_SECRET_KEY", "kdI33njsd@sltfiJsOn1kd90k");
...
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "ehelsetest@gmail.com");
define("EMAIL_SMTP_PASSWORD", "J4Nj1O0i8udn");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://localhost/login/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Ehelse-editor");
define("EMAIL_PASSWORDRESET_SUBJECT", "Resetting av passord Ehelse-editor");
define("EMAIL_PASSWORDRESET_CONTENT", "Klikk på lenken for å resette passord:");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "http://localhost/login/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@example.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Ehelse-editor");
define("EMAIL_VERIFICATION_SUBJECT", "Aktivering av bruker Ehelse-editor");
define("EMAIL_VERIFICATION_CONTENT", "Klikk på lenken for å aktivere brukerkontoen din:");
